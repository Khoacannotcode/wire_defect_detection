...
**config.json:**
- Automatically created in `shipping/` directory
...
**Location:** `shipping/logs/session_YYYYMMDD_HHMMSS.log`
...
- Or manually open files from `shipping/logs/` directory
...
- Check write permissions in `shipping/logs/` directory
